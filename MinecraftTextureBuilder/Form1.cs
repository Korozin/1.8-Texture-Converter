...
namespace MinecraftTextureBuilder
{
    public partial class Form1 : Form
    {
        ...
        {"leather_leggings","chainmail_leggings","iron_leggings","diamond_leggings","gold_leggings","arrow","end_crystal","gold_ingot","gunpowder","bread","sign","door_wood","door_iron","blank","fireball","chorus_fruit" },
        ...
        {"blank","tipped_arrow_base","dragon_breath","name_tag","lead","netherbrick","fish_clownfish_raw","minecart_furnace","charcoal","spawn_egg_overlay","blank","experience_bottle","brewing_stand","magma_cream","dye_powder_cyan","dye_powder_orange" },
        {"leather_leggings_overlay","tipped_arrow_head","lingering_potion","barrier","mutton_raw","rabbit_raw","fish_pufferfish_raw","minecart_hopper","hopper","nether_star","emerald","book_writable","book_written","flower_pot","dye_powder_silver","dye_powder_white" },
        {"leather_boots_overlay","beetroot","beetroot_seeds","beetroot_soup","mutton_cooked","rabbit_cooked","fish_salmon_raw","minecart_tnt","armor_stand","fireworks","fireworks_charge","fireworks_charge_overlay","quartz","map","item_frame","book_enchanted" },
        ...
        {"structure_void","blank","totem_of_undying","shulker_shell","iron_nugget","rabbit_foot","rabbit_hide","blank","blank","blank","blank","blank","blank","blank","blank","dragon_charge" },
        {"13","cat","blocks","chirp","far","mall","mellohi","stal","strad","ward","11","wait","cod_bucket","salmon_bucket","pufferfish_bucket","tropical_fish_bucket" },
        {"leather_horse_overlay","blank","blank","blank","blank","blank","blank","kelp","dried_kelp","sea_pickle","nautilus_shell","heart_of_the_sea","turtle_helmet","scute","trident","phantom_membrane" }
        };
        ...
        string[,] BlockSheetArray =
        {
            ...
            {"lever","door_wood_lower","door_iron_lower","redstone_torch_on","stonebrick_mossy","stonebrick_cracked","pumpkin_top","netherrack","soul_sand","glowstone","piston_top_sticky","piston_top","piston_side","piston_bottom","piston_inner","pumpkin_stem_disconnected" },
            ...
            {"lapis_block","wool_colored_green","wool_colored_lime","repeater_on","glass_pane_top","chest_top","ender_chest_top","turtle_egg_slightly_cracked","turtle_egg_very_cracked","jungle_log","cauldron_side","cauldron_bottom","brewing_stand_base","brewing_stand","endframe_top","endframe_side" },
            {"lapis_ore","wool_colored_brown","wool_colored_yellow","rail_golden","redstone_cross","redstone_line_horizontal","enchanting_table_top","dragon_egg","cocoa_stage_2","cocoa_stage_1","cocoa_stage_0","emerald_ore","trip_wire_source","trip_wire","end_portal_frame_eye","end_stone" },
            {"sandstone_top","wool_colored_blue","wool_colored_light_blue","rail_golden_powered","blank","blank","enchanting_table_side","enchanting_table_bottom","glide_blue","item_frame","flower_pot","comparator_off","comparator_on","rail_activator","rail_activator_powered","quartz_ore" },
            {"sandstone_normal","wool_colored_purple","wool_colored_magenta","rail_detector","jungle_leaves","black_concrete","planks_spruce","planks_jungle","carrots_stage_0","carrots_stage_1","carrots_stage_2","carrots_stage_3","slime","water_debug","water_debug","water_debug" },
            {"sandstone_bottom","wool_colored_cyan","wool_colored_orange","redstone_lamp_off","redstone_lamp_on","stonebrick_carved","planks_birch","anvil_base","anvil_top_damaged_1","quartz_block_chiseled_top","quartz_block_lines_top","quartz_block_side","hopper_outside","rail_detector_powered","water_debug","water_debug" },
            {"nether_brick","wool_colored_silver","nether_wart_stage_0","nether_wart_stage_1","nether_wart_stage_2","sandstone_carved","sandstone_smooth","anvil_top_damaged_0","anvil_top_damaged_2","chiseled_quartz_block_bottom","quartz_block_lines","quartz_block_top","hopper_inside","lava_debug","lava_debug","lava_debug" },
            {"destroy_stage_0","destroy_stage_1","destroy_stage_2","destroy_stage_3","destroy_stage_4","destroy_stage_5","destroy_stage_6","destroy_stage_7","destroy_stage_8","destroy_stage_9","hay_block_side","quartz_block_bottom","hopper_top","hay_block_top","lava_debug","lava_debug" },
            ...
            {"flower_allium","flower_blue_orchid","flower_houstonia","flower_oxeye_daisy","flower_tulip_red","flower_tulip_white","sapling_acacia","sapling_roofed_oak","coarse_dirt","dirt_podzol_side","dirt_podzol_top","leaves_spruce","leaves_spruce","rough_prismarine","red_sandstone_carved","red_sandstone_smooth" },
            {"door_acacia_upper","door_birch_upper","door_dark_oak_upper","door_jungle_upper","door_spruce_upper","chorus_flower","chorus_flower_dead","chorus_plant","end_stone_bricks","grass_path_side","grass_path_top","barrier","ice_packed","sea_lantern","daylight_detector_inverted_top","iron_trapdoor" },
            {"door_acacia_lower","door_birch_lower","door_dark_oak_lower","door_jungle_lower","door_spruce_lower","purpur_block","purpur_pillar","purpur_pillar_top","end_rod","magma","nether_wart_block","red_nether_bricks","frosted_ice_0","frosted_ice_1","frosted_ice_2","frosted_ice_3" },
            {"beetroots_stage_0","beetroots_stage_1","beetroots_stage_2","beetroots_stage_3","green_cmd","green_cmd","green_cmd","green_cmd","cmd","cmd","cmd","cmd","purple_cmd","purple_cmd","purple_cmd","purple_cmd" },
            ...
            {"white_shulker_box","blank","water_overlay","tall_seagrass_top","tube_coral_block","bubble_coral_block","brain_coral_block","fire_coral_block","horn_coral_block","tube_coral","bubble_coral","brain_coral","fire_coral","horn_coral","sea_pickle","blue_ice" },
            {"dried_kelp_top","dried_kelp_side","seagrass","tall_seagrass_bottom","dead_tube_coral_block","dead_bubble_coral_block","dead_brain_coral_block","dead_fire_coral_block","dead_horn_coral_block","tube_coral_fan","bubble_coral_fan","brain_coral_fan","fire_coral_fan","horn_coral_fan","blank","blank" },
            {"large_kelp_bottom","large_kelp_bottom","large_kelp_bottom","large_kelp_bottom","large_kelp_top","large_kelp_top","large_kelp_top","large_kelp_top","seagrass_2","dead_tube_coral_fan","dead_bubble_coral_fan","dead_brain_coral_fan","dead_fire_coral_fan","dead_horn_coral_fan","blank","spruce_trapdoor" },
        ...
        string[,] armour = 
            {
                ...
                { "\\armor\\leather_layer_1_overlay", "\\cloth_1_b"},
